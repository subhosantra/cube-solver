...
from cube.rubik.color import *
from cube.rubik import facecube
from cube.rubik.coordcube import CoordCube, getPruning
from cube.rubik.cubiecube import CubieCube
...
def patternize(facelets, pattern):
    facelets_cc = facecube.FaceCube(facelets).toCubieCube()
    patternized_cc = CubieCube()
    facecube.FaceCube(pattern).toCubieCube().invCubieCube(patternized_cc)
